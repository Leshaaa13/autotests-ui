...
class CoursesListPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.course_max_text = page.get_by_test_id('course-min-score-info-row-view-text')
    ...
    def check_visible_course_card(self, title: str, max_score: str, min_score: str, estimated_time: str, index: int):
